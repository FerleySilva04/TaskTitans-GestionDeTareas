...
export function AppSidebar({ props, user }: { props: SidebarProps, user: UserProps }) {
    ...
    return (
        ...
        <SidebarContent className="p-4 bg-gradient-to-r from-blue-300 to-blue-500 text-white">
            <SidebarGroup>
                <SidebarGroupLabel className="text-white">Task Manager</SidebarGroupLabel>
                <SidebarGroupContent>
                    <SidebarMenu>
        ...
        {props.withFooter &&
            <SidebarFooter className="p-4 bg-gradient-to-r from-blue-300 to-blue-500 text-white">
